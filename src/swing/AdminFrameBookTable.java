...
public class AdminFrameBookTable extends JPanel implements ActionListener, ListSelectionListener {
	...
	public AdminFrameBookTable(String carNumber) {
	...
	void userTableInit() {
		...
		if (Main.cmgr.bookMatches(carNumber) != null) {
			for (Book b : Main.cmgr.bookMatches(carNumber))
